...
######################################################################################################
	...
	def setupStateMachine(self):
		...
		#transition8 : state_initial_wp to state _inter_wp
		...
		#transition9 : state_inter_wop to state_final_wop
...
###########################################3
        ...
        app.connect(q.artistButton ,QtCore.SIGNAL('pressed()'),q.artistslot)
   	app.connect(q.genreButton ,QtCore.SIGNAL('pressed()'),q.genreslot)
